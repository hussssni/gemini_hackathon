...
- "explore" if the destination is NOT on the recorded map. You cannot know where it
  ...
  picked, with an honest "why". Confidence should be modest, and say plainly in the
  summary that this is a guess to try, not a known route.

  Route them to that branch by the SHORTEST way over the recorded map. If they are
  already standing at the landmark the branch leaves from, the only step is to take
  it — do not send them anywhere first. Never walk them past the branch and back.
